...
/**
 * Boutons OAuth pour connexion Google et Microsoft (Outlook)
 */
...
export function OAuthButtons({ redirectTo, className = '' }: OAuthButtonsProps) {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Ne pas retirer le loading car l'utilisateur est redirigé
  ...
  const handleAzureLogin = async () => {
    ...
    try {
      ...
      console.error('Unexpected Azure OAuth error:', error)
      alert('Erreur inattendue')
    } finally {
      // Ne pas retirer le loading car l'utilisateur est redirigé
...
/**
 * Divider "OU" pour séparer OAuth des autres méthodes
 */
